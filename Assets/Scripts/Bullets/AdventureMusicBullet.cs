...
public class AdventureMusicBullet : MusicBulletBase {
	...
	public override Vector3 StartMove(float remainTime,float x,float y,float delayTime = 0,bool _isSlide = false,int _slideIndex = 0,float scaleSpeed = 0.025f)
	{
		return Vector3.zero;
	}
}
